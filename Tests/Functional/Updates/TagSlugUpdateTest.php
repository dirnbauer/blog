 ...
 */
final class TagSlugUpdateTest extends FunctionalTestCase
{
    ...
    public function updateTest(): void
    {
        ...
        $this->importCSVDataSet(__DIR__ . '/Fixtures/TagSlugUpdate/Input.csv');
        self::assertTrue($subject->updateNecessary());
        $subject->executeUpdate();
        self::assertFalse($subject->updateNecessary());
        $this->assertCSVDataSet(__DIR__ . '/Fixtures/TagSlugUpdate/Result.csv');
